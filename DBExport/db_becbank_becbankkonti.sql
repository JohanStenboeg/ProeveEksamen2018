...
--
-- Table structure for table `becbankkonti`
--

DROP TABLE IF EXISTS `becbankkonti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `becbankkonti` (
...
--
-- Dumping data for table `becbankkonti`
--

LOCK TABLES `becbankkonti` WRITE;
/*!40000 ALTER TABLE `becbankkonti` DISABLE KEYS */;
/*!40000 ALTER TABLE `becbankkonti` ENABLE KEYS */;
UNLOCK TABLES;
